...
<script src="assets/modules/izitoast/js/iziToast.min.js"></script>
 <script>
 iziToast.success({
    title: 'Partner Service Section!!',
    message: 'Partner Service Insert Successfully!!',
    position: 'topRight'
  });
  </script>
...
?>
<script>
setTimeout(function(){ window.location.href="add_pservice.php";}, 3000);
</script>
<?php 
...
<script>
 iziToast.success({
    title: 'Partner Service Section!!',
    message: 'Partner Service Update Successfully!!',
    position: 'topRight'
  });
  </script>
...
?>
<script>
setTimeout(function(){ window.location.href="list_pservice.php";}, 3000);
</script>
<?php 
...
$(document).on('change','.cat',function()
{
	...
	$.ajax({
		...
		success:function(response)
		{
			...
			{
				$(".child").html('<label>Service Child Category</label><select name="mcat" class="form-control" required><option value="">Select Service Child Category</option></select>');
				$.ajax({
					type:'post',
					url:'fillchild.php',
					cache:false,
