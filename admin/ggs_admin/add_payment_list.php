...
?>
<script>
setTimeout(function(){ window.location.href="list_payment_list.php";}, 3000);
</script>
<?php 
...
<?php 
 ...
 iziToast.error({
    ...
    position: 'topRight'
	 ...
	 <script>
setTimeout(function(){ window.location.href="list_payment_list.php";}, 2000);
</script>
...
<script src="assets/common/tag.js"></script>
