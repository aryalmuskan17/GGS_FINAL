...
$table="tbl_order";
  $field_values=array("uid","odate","p_method_id","address","o_total","subtotal","trans_id","cid","add_on","add_total","add_per_price","time","date","longs","lats","wal_amt");
  $data_values=array("$uid","$timestamp","$p_method_id","$full_address","$product_total","$product_subtotal","$transaction_id","$cid","$add_on","$add_total","$add_per_price","$time","$date","$longs","$lats","$wal_amt");
